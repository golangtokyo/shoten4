...
====[column] 1. Goコントリビュータを講師に招いてワークショップ
...
@<href>{https://talks.godoc.org/github.com/davecheney/introduction-to-go/introduction-to-go.slide#1}
====[/column]

====[column] 2. GCP Global Meetupの開催
...
====[column] 3. GDG Devfest Tokyoへの参加
...
その際のスライドについては、こちらのURLからご覧いただけます。
@<href>{https://speakerdeck.com/mom0tomo/gotu-ran-ri-ji}
====[/column]

====[column] 4. プログラミング初学者向けのワークショップ
...
====[column] 1. 参加者が安心できる、クリーンであたたかいコミュニティ運営を続けること。
...
====[column] 2. 参加者が教えてもらうだけではなく、参加者やスタッフ同士で教え合える機会をつくること。
