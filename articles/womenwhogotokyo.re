...
2017年6月には、GCPUG Tokyo(Google Cloud Platform User Group)とイベントを共催しました。GDG Cloud Londonからは、女性エンジニアの@chibichibibrが来日し、テクノロジー業界でのダイバーシティについてプレゼンテーションをしました。  
Women Who Goも共催コミュニティとして、私が、GCP x Goをテーマに、Cloud Vision APIとGoを使って画像コンテンツ分析をするプレゼンテーションをしました。

#### GDG Devfest Tokyoへの参加
2017年10月には、GDG Devfest Tokyo 2017に、初めてWomen Who Go Tokyoとして参加をしました。一緒にスタッフとして活動している@micchiebearさんと@mom0tomoさんが、初めてGoを学んでからプロダクトに導入するまでの経験についてプレゼンテーションをしました。  
その際のスライドについては、こちらのURLからご覧いただけます。  
...
以上のアクションを踏まえ、わたしたちは新たなヴィジョンを掲げていきます。
...
そして、一緒に活動を盛り上げてくださる方を募集しています。少しでもご興味がある方は、ぜひ@wwg_tokyoのTwitterアカウントまでご連絡ください。
