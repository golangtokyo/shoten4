...
また、先日GTUG Girlsのみなさまとの共催イベントで教えてもらった"なごみタイム"(お菓子をたべながらアイスブレイクする時間)は、参加者同士のアイスブレイクにちょうどよかったので、Women Who Go Tokyoでも"Gopherカフェ"として取り入れたいと思っています。
...
先日、私たちはHumans Who Go Tokyoというもくもく会を開催しました。これは普段のイベントとは異なり、性別の隔てなく全ての人に向けて公開したイベントです。
第1回ということで参加者はスタッフが中心でしたが、有志のGopherが集まってもくもくする楽しいイベントとなりました。
