...
本記事は、Goにおけるゲーム開発事情について雑多にまとめたものです。
...
実際、前回および前々回の技術書典でGoのゲーム開発に関する本を書いたのですが、
...
1つ目はネイティブコンパイルによって実行が高速であることです。
一般的に、ゲームは実行速度が重要です。
...
以上まとめると、Goでゲーム開発すると以下のような嬉しいことがあります:
